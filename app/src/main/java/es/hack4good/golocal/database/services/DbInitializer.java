    ...
    public void initialize(AppDatabase db) {
        if(db.productDAO().getAllProducts().isEmpty()) {
            ...
            for (int i = 0; i < productNamesBarPepe.size(); i++) {
                db.productDAO().insertProduct(new Product(i, productNamesBarPepe.get(i), productDescriptionsBares.get(i), pricesBarPepe.get(i), typesBares.get(i), 0, imagesBares.get(i), stocksBares.get(i)));
            }
            for (int i = 0; i < productNamesCaManolo.size(); i++) {
                db.productDAO().insertProduct(new Product(i, productNamesCaManolo.get(i), productDescriptionsBares.get(i), pricesCaManolo.get(i), typesBares.get(i), 1, imagesBares.get(i), stocksBares.get(i)));
            }
            for (int i = 0; i < productNamesCerveceriaElGustazo.size(); i++) {
                db.productDAO().insertProduct(new Product(i, productNamesCerveceriaElGustazo.get(i), productDescriptionsBares.get(i), pricesCerveceriaElGustazo.get(i), typesBares.get(i), 2, imagesBares.get(i), stocksBares.get(i)));
            }
            for (int i = 0; i < productNamesElRinconDeRick.size(); i++) {
                db.productDAO().insertProduct(new Product(i, productNamesElRinconDeRick.get(i), productDescriptionsBares.get(i), pricesElRinconDeRick.get(i), typesBares.get(i), 3, imagesBares.get(i), stocksBares.get(i)));
            }
            for (int i = 0; i < productNamesEliteII.size(); i++) {
                db.productDAO().insertProduct(new Product(i, productNamesEliteII.get(i), productDescriptionsBares.get(i), pricesEliteII.get(i), typesBares.get(i), 4, imagesBares.get(i), stocksBares.get(i)));
            }
            for (int i = 0; i < productNamesLaTahona.size(); i++) {
                db.productDAO().insertProduct(new Product(i, productNamesLaTahona.get(i), productDescriptionsBares.get(i), pricesLaTahona.get(i), typesBares.get(i), 5, imagesBares.get(i), stocksBares.get(i)));
            }
            for (int i = 0; i < productNamesGranjaAntonio.size(); i++) {
                db.productDAO().insertProduct(new Product(i, productNamesGranjaAntonio.get(i), productDescriptionsGranjaAntonio.get(i), pricesGranjaAntonio.get(i), typesGranjaAntonio.get(i), 6, imagesGranjaAntonio.get(i), stocksGranjaAntonio.get(i)));
            }
            for (int i = 0; i < productNamesLasCosturasDeAmelia.size(); i++) {
                db.productDAO().insertProduct(new Product(i, productNamesLasCosturasDeAmelia.get(i), productDescriptionsLasCosturasDeAmelia.get(i), pricesLasCosturasDeAmelia.get(i), typesLasCosturasDeAmelia.get(i), 7, imagesLasCosturasDeAmelia.get(i), stocksLasCosturasDeAmelia.get(i)));
            }
            // Insert users
